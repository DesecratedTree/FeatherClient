...
public class Class475 {
	...
	public ClientScriptMap getClientScriptMap(int id, int i_0_) {
		try {
			...
			if (null != class483)
				return class483;
			byte[] is = (((Class475) this).aClass243_5981.getFileFromArchive(Class120.aClass120_1413.method1307(id, -1240874866), Class120.aClass120_1413.method1305(id, -2003896976), (byte) -65));
