		...
		try {
			if (null != Class301_Sub1.aClass298_Sub37_Sub13_3218) {
				...
				if (Class301_Sub1.anInt7624 * -1289394455 < 10) {
					if (!Class301_Sub1.worldMapIndex.method2312(Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640, -2140139718)) {
						Class301_Sub1.anInt7624 = (Class_v.index_23_worldMap.method2305((Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640), -1210672889)) / 10 * 1078186329;
						return;
					}
				...
				if (10 == Class301_Sub1.anInt7624 * -1289394455) {
					...
					if (Class301_Sub1.worldMapIndex.method2295(new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640).append("_staticelements").toString(), -400372089)) {
						if (!Class301_Sub1.worldMapIndex.method2312(new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640).append("_staticelements").toString(), -2145213052))
							return;
						Class301_Sub1.aClass296_3235 = (Class237.method2192(Class301_Sub1.worldMapIndex, new StringBuilder().append(Class301_Sub1.aClass298_Sub37_Sub13_3218.aString9640).append("_staticelements").toString(), client.isMemberWorld, 565671699));
					} else
