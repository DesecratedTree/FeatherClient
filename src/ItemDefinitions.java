...
public class ItemDefinitions {
	...
	public final Model method6028(boolean bool, Class464 class464, int i) {
		try {
			...
			if (i_3_ == -1)
				return null;
			Model class64 = Model.method751((((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass243_5992), i_3_, 0);
			if (class64 == null)
				return null;
			...
			if (!bool && (0 != ((ItemDefinitions) this).anInt5742 * -1268579363 || 345393423 * ((ItemDefinitions) this).anInt5744 != 0 || 0 != ((ItemDefinitions) this).anInt5748 * 669576861))
				class64.method753(((ItemDefinitions) this).anInt5742 * -1268579363, 345393423 * ((ItemDefinitions) this).anInt5744, 669576861 * ((ItemDefinitions) this).anInt5748);
			if (bool && (0 != -1436808331 * ((ItemDefinitions) this).anInt5743 || -92251131 * ((ItemDefinitions) this).anInt5745 != 0 || ((ItemDefinitions) this).anInt5710 * 1813909637 != 0))
				class64.method753(((ItemDefinitions) this).anInt5743 * -1436808331, ((ItemDefinitions) this).anInt5745 * -92251131, 1813909637 * ((ItemDefinitions) this).anInt5710);
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				...
				for (int i_8_ = 0; i_8_ < ((ItemDefinitions) this).aShortArray5754.length; i_8_++)
					class64.method756(((ItemDefinitions) this).aShortArray5754[i_8_], is[i_8_]);
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				...
				for (int i_9_ = 0; i_9_ < ((ItemDefinitions) this).aShortArray5711.length; i_9_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_9_], is[i_9_]);
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
	...
	public final Class387 method6029(GraphicsToolkit class_ra, int i, int i_10_, Class366 class366, Class438 class438, int i_11_, int i_12_, int i_13_, int i_14_, int i_15_) {
		try {
			...
			synchronized (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994) {
				class387 = ((Class387) (((Class477) ((ItemDefinitions) this).aClass477_5751).aClass348_5994.get((long) (1027112447 * ((ItemDefinitions) this).anInt5740 | class_ra.anInt5298 * 580915349 << 29))));
			}
			if (null == class387 || class_ra.method5017(class387.m(), i_18_) != 0) {
				...
				if (((ItemDefinitions) this).anInt5758 * -1773084507 != 128)
					i_19_ |= 0x4;
				Model class64 = Model.method751((((Class477) ((ItemDefinitions) this).aClass477_5751).aClass243_5992), (((ItemDefinitions) this).anInt5738 * 381556007), 0);
				if (null == class64)
					return null;
				if (class64.anInt630 < 13)
					class64.method755(2);
				class387 = (class_ra.method5037(class64, i_19_, (((Class477) ((ItemDefinitions) this).aClass477_5751).anInt5991) * -424819635, 64 + 856370373 * ((ItemDefinitions) this).anInt5761, ((ItemDefinitions) this).anInt5762 * 1055603853 + 850));
	...
	int[] method6031(GraphicsToolkit class_ra, GraphicsToolkit class_ra_27_, int i, int i_28_, int i_29_, boolean bool, int i_30_, Class264 class264, Class366 class366, int i_31_) {
		...
		try {
			...
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				for (int i_32_ = 0; i_32_ < ((ItemDefinitions) this).aShortArray5754.length; i_32_++) {
					if (((ItemDefinitions) this).aByteArray5708 != null && i_32_ < ((ItemDefinitions) this).aByteArray5708.length)
						class64.method756((((ItemDefinitions) this).aShortArray5754[i_32_]), aShortArray5757[(((ItemDefinitions) this).aByteArray5708[i_32_]) & 0xff]);
					else
						class64.method756((((ItemDefinitions) this).aShortArray5754[i_32_]), (((ItemDefinitions) this).aShortArray5706[i_32_]));
				}
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				for (int i_33_ = 0; i_33_ < ((ItemDefinitions) this).aShortArray5711.length; i_33_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_33_], (((ItemDefinitions) this).aShortArray5712[i_33_]));
			}
			if (null != class366) {
			...
			Class387 class387 = class_ra.method5037(class64, i_36_, 64, (((ItemDefinitions) this).anInt5761 * 856370373 + 64), 768 + (((ItemDefinitions) this).anInt5762 * 1055603853));
			...
			class222_40_.method2064((float) (252709809 * anInt5717 << 2), (float) ((((Class220.anIntArray2483[330519029 * anInt5714 << 3]) * i_38_) >> 14) - class387.YA() / 2 + (-1811316489 * anInt5718 << 2)), (float) ((((Class220.anIntArray2474[330519029 * anInt5714 << 3]) * i_38_) >> 14) + (anInt5718 * -1811316489 << 2)));
	...
	public int method6037(int i, int i_62_, int i_63_) {
		try {
			if (null == ((ItemDefinitions) this).aClass437_5766)
				return i_62_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((ItemDefinitions) this).aClass437_5766.method5812((long) i));
	...
	public final Model method6040(boolean bool, Class464 class464, int i) {
		try {
			...
			if (-1 == i_80_)
				return null;
			Model class64 = Model.method751((((Class477) (((ItemDefinitions) this).aClass477_5751)).aClass243_5992), i_80_, 0);
			if (class64.anInt630 < 13)
				class64.method755(2);
			if (-1 != i_81_) {
			...
			if (null != ((ItemDefinitions) this).aShortArray5754) {
				...
				for (int i_83_ = 0; i_83_ < ((ItemDefinitions) this).aShortArray5754.length; i_83_++)
					class64.method756(((ItemDefinitions) this).aShortArray5754[i_83_], is[i_83_]);
			}
			if (null != ((ItemDefinitions) this).aShortArray5711) {
				short[] is;
				...
				for (int i_84_ = 0; i_84_ < ((ItemDefinitions) this).aShortArray5711.length; i_84_++)
					class64.method752(((ItemDefinitions) this).aShortArray5711[i_84_], is[i_84_]);
			}
			return class64;
		} catch (RuntimeException runtimeexception) {
	...
	public String method6041(int i, String string, short i_85_) {
		try {
			if (((ItemDefinitions) this).aClass437_5766 == null)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((ItemDefinitions) this).aClass437_5766.method5812((long) i));
	...
	public static int method6043(int i, int i_90_, int i_91_) {
		try {
			if (LinkedList.aClass371_5520.anInt4035 * -1919698893 == -1)
				return 1;
			...
			try {
				...
				Model class64 = Model.method751(Class341.aClass243_3646, (-1919698893 * LinkedList.aClass371_5520.anInt4035), 0);
