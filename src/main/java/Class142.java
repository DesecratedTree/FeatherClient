			...
			if (client.aClass283_8716.method2675(-1611682495) == null)
				...
				if (bool_6_)
					...
					if (Class298_Sub1.anInt7164 * -863531439 == 4) {
						...
						Class482.method6121(1103750049 * Class75.anInt708, Class356.method4271((int) class217.aFloat2451, (int) class217.aFloat2454, Class99.anInt952 * 1855729883, -1979916029) - 200, Class106.anInt1309 * 1346160791, i_7_, i_8_, (i_7_ >> 3) * 3 + ClientSettings.zoom << 2, i_4_, -1059521295);
