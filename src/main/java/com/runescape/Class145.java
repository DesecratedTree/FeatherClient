...
public class Class145 implements Interface5 {
	...
	static final void method1595(IComponentDefinition class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method1596(ClientScript2 class403, int i) {
		try {
			...
			IComponentDefinition class105 = ((Class390) class390).aClass105_4168;
			Class119 class119 = ((Class390) class390).aClass119_4167;
			MapDecoder_Sub1.method2244(class105, class119, class403, (byte) -89);
		} catch (RuntimeException runtimeexception) {
					...
					for (int i_56_ = 0; i_56_ < class296.anInt3169 * -1407078377; i_56_++) {
						...
						if ((Class287.myPlayer.plane) == i_57_ >> 28) {
							...
							if (i_58_ >= 0 && i_58_ < i_4_ && i_59_ >= 0 && i_59_ < i_5_)
								Class3.aClass453_61.method5935(new Class298_Sub35(i_56_), 1131322080);
							else {
								...
								if (null != class352.anIntArray3803 && (i_58_ + 968926443 * class352.anInt3793 >= 0)) {
									if (i_58_ + 1281846757 * class352.anInt3804 >= i_4_) {
										...
										if (i_59_ + (class352.anInt3805 * -1901940595) >= i_5_) {
											...
											Class3.aClass453_61.method5935(new Class298_Sub35(i_56_), 1459840700);
									}
								}
							}
						}
