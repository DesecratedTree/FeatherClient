...
public class Class298_Sub28 extends Class298 {
	...
	static final void method3108(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anObjectArray5234[(((ClientScript2) class403).integerstack[((ClientScript2) class403).integerPos * 1883543357])] = (((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 -= 969361751) * -203050393)]);
