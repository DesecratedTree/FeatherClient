...
public abstract class Class247 {
	...
	Class247() {
		...
		anInt2735 = 0;
		anInt2745 = 0;
		((Class247) this).aClass298_Sub53_2737 = new RsByteBuffer(10);
	}
	...
	static final void method2367(ClientScript2 class403, int i) {
		try {
			...
			if (null == class298_sub52) {
				...
				int i_6_ = (-1740053407 * class298_sub52.anInt7605 << 28 | (2122110429 * class298_sub52.anInt7607 + WorldMap.mapX) << 14 | (WorldMap.mapY + -372920341 * class298_sub52.anInt7610));
