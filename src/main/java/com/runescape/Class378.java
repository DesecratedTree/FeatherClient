...
public class Class378 {
	...
	static final void method4669(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393 - 1)] = (((ClientScript2) class403).anObjectArray5234[(((ClientScript2) class403).integerstack[1883543357 * ((ClientScript2) class403).integerPos])]);
