...
public abstract class Class291 implements Interface14, Runnable, FocusListener, WindowListener {
	...
	final void method2752(String string, String string_5_, int i, int i_6_, int i_7_, int i_8_, byte i_9_) throws Exception {
		try {
			...
			Class68.aStringArray679 = (new String[] { new StringBuilder().append(".feather_cache_").append(Class139.anInt1548 * -518493991).toString(), new StringBuilder().append(".file_store_").append(-518493991 * Class139.anInt1548).toString() });
	...
	File method2783(String string, String string_27_, int i, short i_28_) {
		try {
			...
			Class180.aFile6528 = new File(Class83.aString765, new StringBuilder().append("feather_cl_").append(string).append("_").append(string_27_).append(string_29_).append(".dat").toString());
			...
			if (string_30_ == null) {
				string_30_ = new StringBuilder().append(Class83.aString765).append(File.separatorChar).append(ClientSettings.CACHE_NAME).append(string_29_).append(File.separatorChar).append(string).append(File.separatorChar).append(string_27_).append(File.separatorChar).toString();
				bool = true;
			}
			if (null != string_31_) {
