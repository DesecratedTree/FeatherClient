...
public class Class298_Sub48 extends Class298 {
	...
	void method3537(boolean bool, int i) {
		try {
			...
			if (bool || null == aClass422_Sub8_7566)
	...
	public Class411 method3541(byte i) {
		try {
			return ((Class298_Sub48) this).aClass411_7568;
		} catch (RuntimeException runtimeexception) {
	...
	public Class417 method3543(int i) {
		try {
			return ((Class298_Sub48) this).aClass417_7562;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("aco.x(").append(')').toString());
		}
	}

	void method3544(RsByteBuffer class298_sub53, int i) {
		try {
			if (class298_sub53 == null || null == class298_sub53.buffer)
				...
				if (i_5_ < 23) {
					try {
						method3538(class298_sub53, i_5_, 1254790663);
	...
	public Class298_Sub48(Class411 class411, int i) {
		((Class298_Sub48) this).aClass411_7568 = class411;
		((Class298_Sub48) this).aClass417_7562 = new Class417(Class291.maximumMemory * 1126040225, Class291.availableCPU * 1090452523, (Class344.aString3687.toLowerCase().indexOf("arm") != -1));
	...
	public Class298_Sub48(RsByteBuffer class298_sub53, Class411 class411, int i) {
		((Class298_Sub48) this).aClass411_7568 = class411;
		((Class298_Sub48) this).aClass417_7562 = new Class417(Class291.maximumMemory * 1126040225, 1090452523 * Class291.availableCPU, Class344.aString3687.indexOf("arm") != -1);
		aClass422_Sub14_7571 = new Class422_Sub14(i, this);
