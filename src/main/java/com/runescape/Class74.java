...
public class Class74 {
	...
	static final void method827(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5692((byte) 0) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method828(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub3_7556.method5632((byte) -40) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			...
			for (int i_15_ = 0; i_15_ < class19s.length; i_15_++) {
				...
				if (class19 != null && 0 != class19.anInt266 * 958933333 && client.anInt8884 * 443738891 % 20 < 10) {
					...
					if (class19.anInt266 * 958933333 == 2) {
						...
						l *= l;
						Class397.method4914(class105, class117, i_12_, i_13_, i_18_, i_19_, (((Class19) class19).anInt258 * -92466201), l);
					}
