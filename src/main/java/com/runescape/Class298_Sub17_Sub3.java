...
public class Class298_Sub17_Sub3 extends Class298_Sub17 {
	...
	static final void method2924(ClientScript2 class403, short i) {
		try {
			((ClientScript2) class403).aLongArray5251[((((ClientScript2) class403).anInt5245 += -682569305) * 1685767703 - 1)] = (((ClientScript2) class403).aLongArray5235[(((ClientScript2) class403).integerstack[1883543357 * ((ClientScript2) class403).integerPos])]);
		} catch (RuntimeException runtimeexception) {
