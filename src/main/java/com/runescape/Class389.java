...
public class Class389 {
	...
	public Class398 method4857(int i, int i_0_) {
		try {
			Class398 class398;
			synchronized (((Class389) this).aClass348_4161) {
				class398 = (Class398) ((Class389) this).aClass348_4161.get((long) i);
			}
			if (class398 != null)
				return class398;
			byte[] is;
			synchronized (((Class389) this).aClass243_4159) {
				is = (((Class389) this).aClass243_4159.getFileFromArchive(Class120.aClass120_1449.method1307(i, -880627246), Class120.aClass120_1449.method1305(i, -2138953670), (byte) -76));
			}
