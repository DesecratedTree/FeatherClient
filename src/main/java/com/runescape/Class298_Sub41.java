...
public class Class298_Sub41 extends Class298 {
	...
	int anInt7439 = 0;
	static LinkedList aClass437_7440;
	int anInt7441;
		...
		try {
			...
			if (null != ((Class298_Sub41) this).aClass432_7435) {
				...
				if (i_1_ != i_0_) {
					...
					NPCDefinitions class503 = (((Class298_Sub41) this).aClass365_Sub1_Sub1_Sub2_Sub1_7433.aClass503_10190);
	...
	static {
		aClass437_7440 = new LinkedList(16);
	}
