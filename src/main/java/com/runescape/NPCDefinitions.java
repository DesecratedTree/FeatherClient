...
public class NPCDefinitions {
			...
			if (class387 == null || (class387.m() & i_6_) != i_6_) {
				...
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_13_ = 0; i_13_ < is_11_.length; i_13_++) {
						...
						} else if (!((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208.method2290(is_11_[i_13_], 0, -1819291215))
							bool_12_ = true;
					}
				}
				if (bool_12_)
				...
				for (int i_14_ = 0; i_14_ < is_11_.length; i_14_++) {
					if (is_11_[i_14_] == -1) {
						...
						synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
							class64s[i_14_] = Model.method751((((Class507) (((NPCDefinitions) this).aClass507_6125)).aClass243_6208), is_11_[i_14_], 0);
						}
				...
				class387.KA(i_6_);
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204) {
					((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6204.method4194(class387, l);
				}
			}
	...
	public final Class387 method6237(GraphicsToolkit class_ra, int i, Interface23 interface23, Class438 class438, Class498 class498, int i_32_) {
		try {
			...
			Class387 class387;
			synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211) {
				class387 = (Class387) ((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211.get(l);
			}
			if (null == class387 || (class387.m() & i_34_) != i_34_) {
				...
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_36_ = 0; i_36_ < is.length; i_36_++) {
						if (!((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208.method2290(is[i_36_], 0, -602703169))
							bool = true;
					}
				}
				if (bool)
				...
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass243_6208) {
					for (int i_37_ = 0; i_37_ < is.length; i_37_++)
						class64s[i_37_] = Model.method751((((Class507) (((NPCDefinitions) this).aClass507_6125)).aClass243_6208), is[i_37_], 0);
				}
				...
				class387.KA(i_34_);
				synchronized (((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211) {
					((Class507) ((NPCDefinitions) this).aClass507_6125).aClass348_6211.method4194(class387, l);
				}
			}
			if (class438 != null) {
	...
	public int method6239(int i, int i_45_, byte i_46_) {
		try {
			if (((NPCDefinitions) this).aClass437_6159 == null)
				return i_45_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((NPCDefinitions) this).aClass437_6159.method5812((long) i));
	...
	public final NPCDefinitions method6240(Interface23 interface23, int i) {
		try {
			int i_47_ = -1;
			if (((NPCDefinitions) this).anInt6171 * 677538211 != -1)
				i_47_ = interface23.method250((677538211 * ((NPCDefinitions) this).anInt6171), (byte) 122);
			else if (((NPCDefinitions) this).anInt6162 * -1248679093 != -1)
				i_47_ = interface23.method252((((NPCDefinitions) this).anInt6162 * -1248679093), (byte) 49);
			if (i_47_ < 0 || i_47_ >= anIntArray6188.length - 1 || -1 == anIntArray6188[i_47_]) {
				int i_48_ = anIntArray6188[anIntArray6188.length - 1];
				if (i_48_ != -1)
					return ((NPCDefinitions) this).aClass507_6125.method6269(i_48_, 749174826);
				return null;
			}
			return ((NPCDefinitions) this).aClass507_6125.method6269(anIntArray6188[i_47_], 541835254);
		} catch (RuntimeException runtimeexception) {
	...
	NPCDefinitions() {
		...
		aBoolean6155 = false;
		aBoolean6173 = false;
		((NPCDefinitions) this).anInt6137 = 0;
		((NPCDefinitions) this).anInt6156 = 0;
		anInt6185 = -945207309;
		anInt6178 = 537547649;
		anInt6181 = -68186784;
	...
	public boolean method6241(Interface23 interface23, int i) {
		try {
			if (null == anIntArray6188)
				return true;
			int i_49_ = -1;
			if (-1 != ((NPCDefinitions) this).anInt6171 * 677538211)
				i_49_ = interface23.method250((677538211 * ((NPCDefinitions) this).anInt6171), (byte) 4);
			else if (-1248679093 * ((NPCDefinitions) this).anInt6162 != -1)
				i_49_ = interface23.method252((-1248679093 * ((NPCDefinitions) this).anInt6162), (byte) 94);
		...
		try {
			...
			for (int i_51_ = 0; i_51_ < anIntArray6188.length; i_51_++) {
				if (-1 != anIntArray6188[i_51_]) {
					NPCDefinitions class503_52_ = ((NPCDefinitions) this).aClass507_6125.method6269(anIntArray6188[i_51_], -1960092896);
		...
		try {
			if (i == 1) {
				...
				if (677538211 * ((NPCDefinitions) this).anInt6171 == 65535)
					((NPCDefinitions) this).anInt6171 = 70774261;
				((NPCDefinitions) this).anInt6162 = stream.readUnsignedShort() * -1169422749;
				...
				if (((NPCDefinitions) this).aClass437_6159 == null) {
					...
					((NPCDefinitions) this).aClass437_6159 = new LinkedList(i_73_);
				}
				for (int i_74_ = 0; i_74_ < i_72_; i_74_++) {
					...
					((NPCDefinitions) this).aClass437_6159.method5817(class298, (long) i_75_);
				}
			}
		} catch (RuntimeException runtimeexception) {
	...
	public String method6245(int i, String string, int i_76_) {
		try {
			if (null == ((NPCDefinitions) this).aClass437_6159)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((NPCDefinitions) this).aClass437_6159.method5812((long) i));
