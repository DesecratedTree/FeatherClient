...
public class Class257 {
	...
	static final void method2451(IComponentDefinition class105, Class119 class119, ClientScript2 class403, int i) {
		try {
	...
	static final void method2452(ClientScript2 class403, int i) {
		try {
			...
			if (-1673957995 * class468.anInt5755 >= 0 && 809765849 * class468.anInt5709 >= 0)
				((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919) - 1] = class468.anInt5709 * 809765849;
			else
	...
	static final void method2454(ClientScript2 class403, int i) {
		try {
			...
			Class298_Sub37_Sub13 class298_sub37_sub13 = Class298_Sub7.method2864(-1164141102);
