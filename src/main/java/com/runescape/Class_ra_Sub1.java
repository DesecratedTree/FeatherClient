...
public class Class_ra_Sub1 extends GraphicsToolkit {
	...
	Class_ra_Sub1(Interface_ma interface_ma) {
		...
		((Class_ra_Sub1) this).aClass348_7970 = new CachingHashMap(16);
		((Class_ra_Sub1) this).anInt8006 = -2116530773;
		try {
			((Class_ra_Sub1) this).aClass348_7975 = new CachingHashMap(256);
	...
	int[] method5197(int i) {
		...
		synchronized (((Class_ra_Sub1) this).aClass348_7975) {
			class298_sub4 = ((Class298_Sub4) ((Class_ra_Sub1) this).aClass348_7975.get((long) i | ~0x7fffffffffffffffL));
	...
	void method5204(boolean bool, boolean bool_378_, boolean bool_379_, Class302_Sub3_Sub1 class302_sub3_sub1, int i, int i_380_, float f, int i_381_) {
		...
		if (-1 == i_382_)
			...
			if (i_382_ != ((Class_ra_Sub1) this).anInt8006 * -815285507) {
				Class57 class57 = (Class57) ((Class_ra_Sub1) this).aClass348_7970.get((long) i_382_);
				if (class57 == null) {
			...
			i_381_++;
			((Class57_Sub1) ((Class_ra_Sub1) this).aClass57_7992).method678(bool, bool_378_, bool_379_, i - i_383_, i_380_ - i_383_, f, i_381_, i_381_, 0, class302_sub3_sub1.anInt9792, 1, 1, false);
		}
	}
			...
			if (i_390_ != 65535) {
				...
				if (!class53.aBoolean524) {
					if (i_390_ != ((Class_ra_Sub1) this).anInt8006 * -815285507) {
						Class57 class57 = (Class57) ((Class_ra_Sub1) this).aClass348_7970.get((long) i_390_);
						if (null == class57) {
