...
public class Class330 implements Runnable {
	...
	static final void method4004(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).aLongArray5235[(((ClientScript2) class403).integerstack[((ClientScript2) class403).integerPos * 1883543357])] = (((ClientScript2) class403).aLongArray5251[((((ClientScript2) class403).anInt5245 -= -682569305) * 1685767703)]);
		} catch (RuntimeException runtimeexception) {
