...
public abstract class Class288 implements Runnable {
	...
	static final void method2728(IComponentDefinition class105, Class119 class119, ClientScript2 class403, int i) {
		try {
			...
			if (-1 == class105.anInt1154 * -1309843523 && !class119.aBoolean1403)
				Class302_Sub4.method3731(-440872681 * class105.anInt1142, (byte) -31);
		} catch (RuntimeException runtimeexception) {
