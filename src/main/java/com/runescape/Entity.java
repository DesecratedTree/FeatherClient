...
public abstract class Entity extends Class365_Sub1_Sub1 {
	...
	public final void method4420(int i, int i_31_, int i_32_, int i_33_, int i_34_, int i_35_, int i_36_, byte i_37_) {
		try {
			...
			for (int i_39_ = 0; i_39_ < LinkedList.aClass371_5520.anInt4032 * -942466371; i_39_++) {
			...
			if (bool_38_) {
				...
				for (int i_44_ = 1; i_44_ < -942466371 * LinkedList.aClass371_5520.anInt4032; i_44_++) {
					if (i_41_ == 0) {
				...
				for (int i_45_ = 0; i_45_ < LinkedList.aClass371_5520.anInt4032 * -942466371; i_45_++) {
					int i_46_ = ((Entity) this).aByte10133;
					((Entity) this).aByte10133 = (byte) ((((Entity) this).aByte10133 + 1) % (-942466371 * LinkedList.aClass371_5520.anInt4032));
	...
	Entity(Class331 class331, int i) {
		...
		((Entity) this).aByte10133 = (byte) 0;
		anIntArray10102 = new int[-942466371 * LinkedList.aClass371_5520.anInt4032];
		anIntArray10079 = new int[-942466371 * LinkedList.aClass371_5520.anInt4032];
		anIntArray10080 = new int[-942466371 * LinkedList.aClass371_5520.anInt4032];
		anIntArray10081 = new int[LinkedList.aClass371_5520.anInt4032 * -942466371];
		anIntArray10127 = new int[LinkedList.aClass371_5520.anInt4032 * -942466371];
		anIntArray10083 = new int[LinkedList.aClass371_5520.anInt4032 * -942466371];
