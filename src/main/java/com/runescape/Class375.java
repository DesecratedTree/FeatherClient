	...
	public Class373 method4645(int i, int i_0_) {
		try {
			...
			synchronized (((Class375) this).aClass348_4079) {
				class373 = (Class373) ((Class375) this).aClass348_4079.get((long) i);
			}
			if (null != class373)
				return class373;
			byte[] is;
			synchronized (((Class375) this).aClass243_4082) {
				is = (((Class375) this).aClass243_4082.getFileFromArchive(Class120.aClass120_1439.anInt1460 * -1006924897, i, (byte) -18));
			}
