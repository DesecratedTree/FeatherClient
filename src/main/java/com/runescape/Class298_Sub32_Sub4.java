...
public class Class298_Sub32_Sub4 extends Class298_Sub32 {
	...
	void method3163(int i, RsByteBuffer class298_sub53) {
		...
		case 0:
			...
			break;
		case 2:
			((Class298_Sub32_Sub4) this).anInt9337 = ((class298_sub53.readByte(-12558881) << 12) / 100 * -91159229);
			break;
		case 1:
			((Class298_Sub32_Sub4) this).anInt9336 = ((class298_sub53.readByte(-12558881) << 12) / 100 * 634933469);
			break;
		}
	}
