...
public final class Class467 {
	...
	static final void method6023(int i) {
		try {
			...
			for (int i_2_ = 0; i_2_ < i_0_; i_2_++) {
				...
				NPC class365_sub1_sub1_sub2_sub1 = ((NPC) (((Class298_Sub29) client.aClass437_8696.method5812((long) i_3_)).anObject7366));
	...
	static final void method6024(ClientScript2 class403, int i) {
		try {
			int i_9_ = (((ClientScript2) class403).integerstack[1883543357 * ((ClientScript2) class403).integerPos]);
			...
			((Class402) class402).anInt5226 = -985206291 * ((ClientScript2) class403).integerPos;
