	...
	public static Class476 method962(String string, String string_7_, boolean bool, int i) {
		try {
			...
			if (33 == Class139.anInt1548 * -518493991)
				...
				string_9_ = "_wip";
			File file_10_ = new File(Class83.aString765, new StringBuilder().append("noregret_").append(string_7_).append("_preferences").append(string).append(string_9_).append(".dat").toString());
			do {
