...
public class Class445 {
	...
	public Class485 method5892(int i, int i_0_) {
		try {
			...
			if (null != class485)
				return class485;
			byte[] is = ((Class445) this).aClass243_5609.getFileFromArchive(((Class120.aClass120_1411.anInt1460) * -1006924897), i, (byte) -50);
	...
	static void method5895(GraphicsToolkit class_ra, byte i) {
		try {
			...
			class_ra.B(0, 0, -2110394505 * Class462.anInt5683, 350, Class8.anInt98 * 256666041 << 24 | ClientSettings.DEV_CONSOLE_COLOR, 1);
			...
			if (Class8.anInt102 * -2035787443 > 0) {
				...
				class_ra.B(Class462.anInt5683 * -2110394505 - 16, i_5_, 12, i_4_, Class8.anInt98 * 256666041 << 24 | ClientSettings.DEV_CONSOLE_COLOR, 2);
			...
			Class298_Sub46.aClass264_7534.method2474(ClientSettings.CLIENT_BUILD, -2110394505 * Class462.anInt5683 - 25, 330, -1, -16777216, (byte) -63);
