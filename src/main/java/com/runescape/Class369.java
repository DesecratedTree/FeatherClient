...
public class Class369 {
		...
		try {
			if (1 == i)
				...
				if (((Class369) this).aClass437_4018 == null) {
					...
					((Class369) this).aClass437_4018 = new LinkedList(i_17_);
				}
	...
	public int method4568(int i, int i_36_, byte i_37_) {
		try {
			if (null == ((Class369) this).aClass437_4018)
				return i_36_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((Class369) this).aClass437_4018.method5812((long) i));
	...
	public String method4570(int i, String string, int i_38_) {
		try {
			if (null == ((Class369) this).aClass437_4018)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((Class369) this).aClass437_4018.method5812((long) i));
