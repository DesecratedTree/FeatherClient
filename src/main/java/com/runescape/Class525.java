...
public class Class525 {
	...
	static final void method6380(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561.method5612(i_3_, 1352882135);
		} catch (RuntimeException runtimeexception) {
