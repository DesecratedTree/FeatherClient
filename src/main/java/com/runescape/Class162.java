	...
	boolean method1760(int i, String string, byte i_18_) {
		try {
			...
			if (((Class162) this).aClass437_1664 != null) {
				...
				if (class298 != null) {
					if (class298 instanceof Class298_Sub29) {
						...
						if (class298_sub29.anObject7366 instanceof String) {
							...
							class298_sub29.method2839(-1460969981);
							((Class162) this).aClass437_1664.method5817(new Class298_Sub29(string), (7051297995265073167L * class298_sub29.aLong3188));
							return true;
						}
					}
				...
				((Class162) this).aClass437_1664 = new LinkedList(4);
	...
	void method1764(RsByteBuffer class298_sub53, byte i) {
		try {
			...
			if (i_30_ >= 3) {
				...
				if (i_34_ > 0) {
					((Class162) this).aClass437_1664 = new LinkedList(i_34_ < 16 ? Class416.method5590(i_34_, (byte) 16) : 16);
					while (i_34_-- > 0) {
