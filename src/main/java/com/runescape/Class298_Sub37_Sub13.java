...
public class Class298_Sub37_Sub13 extends Class298_Sub37 {
	...
	boolean method3450(int i, int i_0_, byte i_1_) {
		try {
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5939(1766612795); null != class298_sub42; class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5944(49146)) {
	...
	public boolean method3451(int i, int i_2_, int[] is, int i_3_) {
		try {
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5939(1766612795); class298_sub42 != null; class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5944(49146)) {
	...
	void method3454(int i) {
		try {
			...
			anInt9646 = 0;
			for (Class298_Sub42 class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5939(1766612795); class298_sub42 != null; class298_sub42 = (Class298_Sub42) ((Class298_Sub37_Sub13) this).aClass453_9642.method5944(49146)) {
				if (((Class298_Sub42) class298_sub42).anInt7457 * 1528024175 < 1364716801 * anInt9650)
					anInt9650 = (((Class298_Sub42) class298_sub42).anInt7457 * -878769809);
				if (((Class298_Sub42) class298_sub42).anInt7461 * 37578241 > anInt9647 * -2052483955)
					anInt9647 = (((Class298_Sub42) class298_sub42).anInt7461 * -1211577275);
				if (50981941 * ((Class298_Sub42) class298_sub42).anInt7463 < anInt9649 * 1345239131)
					anInt9649 = -608005457 * (((Class298_Sub42) class298_sub42).anInt7463);
				if (1374138429 * ((Class298_Sub42) class298_sub42).anInt7465 > 929385381 * anInt9646)
					anInt9646 = (-1870852423 * ((Class298_Sub42) class298_sub42).anInt7465);
			}
		} catch (RuntimeException runtimeexception) {
	...
	Class298_Sub37_Sub13(int i, String string, String string_9_, int i_10_, int i_11_, boolean bool, int i_12_, int i_13_) {
		anInt9647 = 0;
		anInt9649 = 1374107136;
		anInt9646 = 0;
		((Class298_Sub37_Sub13) this).aBoolean9648 = true;
		anInt9643 = -1929943701 * i;
		aString9640 = string;
		aString9641 = string_9_;
		anInt9644 = i_10_ * 350230413;
		((Class298_Sub37_Sub13) this).anInt9639 = -1105193455 * i_11_;
		((Class298_Sub37_Sub13) this).aBoolean9648 = bool;
		anInt9645 = i_12_ * -715250349;
		if (1110271707 * anInt9645 == 255)
			anInt9645 = 0;
		Class94.method1020(i_13_, 1337257918);
		((Class298_Sub37_Sub13) this).aClass453_9642 = new Class453();
	}
