...
public abstract class Class336 {
	...
	static final void method4092(ClientScript2 class403, int i) {
		try {
			...
			String string_7_ = ((String) (((ClientScript2) class403).anObjectArray5240[-203050393 * ((ClientScript2) class403).anInt5241 + 1]));
			if ((((ClientScript2) class403).anIntArray5244[(((ClientScript2) class403).anInt5239 -= -391880689) * 681479919]) == 1)
				...
				((ClientScript2) class403).anObjectArray5240[((((ClientScript2) class403).anInt5241 += 969361751) * -203050393) - 1] = string_7_;
	...
	static final void method4094(ClientScript2 class403, byte i) {
		try {
			int i_12_ = client.aClass437_8841.method5814(2031939050);
			if (-1 != -257444687 * client.WINDOW_PANE_ID)
				i_12_++;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_12_;
		} catch (RuntimeException runtimeexception) {
