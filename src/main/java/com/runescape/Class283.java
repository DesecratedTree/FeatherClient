...
public class Class283 {
	...
	public void method2648(int i) {
		try {
			anInt3015 = -896386664;
			zFar = ((int) (34.46 * (-991330803 * anInt3039)) * -2038218047) * ClientSettings.FOG_DISTANCE_MULTIPLIER;
	...
	public boolean method2672(int i) {
		try {
			...
			int chunkSize = (Class69.method787(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub24_7554.method5713((byte) 73), (byte) 16).anInt1581 * 2098573928) * ClientSettings.RENDER_DISTANCE_MULTIPLIER;
			if (Class373.aClass_ra4071.method4998()) {
				chunkSize++;
			}
