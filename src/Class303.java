...
public class Class303 {
	...
	public static final void method3737(Player class365_sub1_sub1_sub2_sub2, int i, int i_7_, byte i_8_, byte i_9_) {
		try {
			...
			if (i_10_ >= 0 && i_10_ < client.map.method2629(-2022633621) && i_11_ >= 0 && i_11_ < client.map.method2630(211521322) && (i >= 0 && i < client.map.method2629(-2074801405) && i_7_ >= 0 && i_7_ < client.map.method2630(1180671988))) {
				int i_12_ = (Class298_Sub37.calculateRoute(i_10_, i_11_, class365_sub1_sub1_sub2_sub2.getSize(), Class350.method4214(i, i_7_, (short) 808), (client.map.getSceneClipDataPlane(class365_sub1_sub1_sub2_sub2.plane)), true, client.calculatedScenePositionXs, client.calculatedScenePositionYs));
				if (i_12_ >= 1 && i_12_ <= 3) {
