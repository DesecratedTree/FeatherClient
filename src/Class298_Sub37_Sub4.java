		...
		try {
			...
			if (((Class298_Sub37_Sub4) this).aByteArrayArray9581 == null) {
				synchronized (Class317.aClass243_3321) {
					...
					int[] is = (Class317.aClass243_3321.getFileIds((((Class298_Sub37_Sub4) this).anInt9580 * 1899473659), -2074944518));
					((Class298_Sub37_Sub4) this).aByteArrayArray9581 = new byte[is.length][];
					for (int i_0_ = 0; i_0_ < is.length; i_0_++)
						((Class298_Sub37_Sub4) this).aByteArrayArray9581[i_0_] = (Class317.aClass243_3321.getFileFromArchive((1899473659 * ((Class298_Sub37_Sub4) this).anInt9580), is[i_0_], (byte) -7));
				}
			}
			boolean bool = true;
			...
			synchronized (Class317.aClass243_3321) {
				...
				is = Class317.aClass243_3321.getFileIds((((Class298_Sub37_Sub4) this).anInt9580 * 1899473659), -2046558264);
			}
