	...
	public final Class387 method4918(GraphicsToolkit class_ra, int i, boolean bool, Class_xa class_xa, Class_xa class_xa_8_, int i_9_, int i_10_, int i_11_, Class438 class438, byte i_12_, int i_13_) {
		try {
			...
			synchronized (((Class389) ((Class398) this).aClass389_5210).aClass348_4162) {
				class387 = ((Class387) (((Class389) ((Class398) this).aClass389_5210).aClass348_4162.get((long) ((((Class398) this).anInt5202 = (1757755963 * ((-559444237 * ((Class398) this).anInt5202) | (class_ra.anInt5298 * 580915349 << 29)))) * -559444237))));
			}
			if (class387 == null || class_ra.method5017(class387.m(), i_14_) != 0) {
				...
				if (((Class398) this).aShortArray5208 != null)
					i_15_ |= 0x8000;
				Model class64 = Model.method751((((Class389) ((Class398) this).aClass389_5210).aClass243_4160), (((Class398) this).anInt5204 * -283549117), 0);
				if (class64 == null)
					return null;
				if (class64.anInt630 < 13)
					class64.method755(2);
				class387 = (class_ra.method5037(class64, i_15_, -258957271 * ((Class389) (((Class398) this).aClass389_5210)).anInt4163, 64 + -2043193071 * ((Class398) this).anInt5213, 850 + 1459867577 * ((Class398) this).anInt5214));
