		...
		try {
			...
			if (!forceNew) {
				synchronized (((Class477) this).aClass348_5993) {
					itemdefinition = (ItemDefinitions) ((Class477) this).aClass348_5993.get((long) itemId);
				}
			...
			if (!forceNew && OLD_ITEMS && itemId != 4712) { // disable ahrim body
				is = (((Class477) this).aClass243_5990.getFileFromArchive(Class120.aClass120_1429.method1307(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -100335020), Class120.aClass120_1429.method1305(itemId + (Class298_Sub32_Sub14.aClass477_9400.itemDefinitionsLength * -888767613), -1698958016), (byte) -74));
				oldItem = true;
			}
			if (is == null) {
				synchronized (((Class477) this).aClass243_5990) {
					is = (((Class477) this).aClass243_5990.getFileFromArchive(Class120.aClass120_1429.method1307(itemId, -100335020), Class120.aClass120_1429.method1305(itemId, -1698958016), (byte) -74));
					oldItem = false;
				}
			}
			...
			if (!((Class477) this).aBoolean5999 && itemdefinition.aBoolean5731) {
				...
				if (null != ((ItemDefinitions) itemdefinition).aClass437_5766) {
					boolean bool = false;
					for (Class298 class298 = ((ItemDefinitions) itemdefinition).aClass437_5766.method5816(1739772889); class298 != null; class298 = ((ItemDefinitions) itemdefinition).aClass437_5766.method5815((byte) -94)) {
