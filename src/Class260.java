...
public class Class260 {
	...
	static final void method2460(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub11_7558.method5666(-391880689) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
			throw Class346.method4175(runtimeexception, new StringBuilder().append("kw.anw(").append(')').toString());
		}
	}

	static final void method2461(IComponentDefinition class105, Class119 class119, ClientScript2 class403, short i) {
		try {
			...
			if (i_2_ >= 0 && i_2_ < 5) {
				...
				if (class105.anInt1154 * -1309843523 == -1 && !class119.aBoolean1403)
					Class85.method958(-440872681 * class105.anInt1142, i_2_, (byte) 1);
			}
		} catch (RuntimeException runtimeexception) {
