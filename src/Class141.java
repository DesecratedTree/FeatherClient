...
public class Class141 implements Interface6 {
	...
	public void method58(boolean bool, byte i) {
		try {
			if (bool)
				Class373.aClass_ra4071.B(0, 0, Class462.anInt5683 * -2110394505, -1111710645 * Class298_Sub40_Sub9.anInt9716, 1751631615 * ((Class141) this).aClass145_6389.anInt6344, 0);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1566(ClientScript2 class403, int i) {
		try {
			Class422_Sub25.aClass298_Sub48_8425.method3540(Class422_Sub25.aClass298_Sub48_8425.aClass422_Sub18_7561, (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]) == 1 ? 1 : 0, -1896213464);
