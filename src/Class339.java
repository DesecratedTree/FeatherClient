...
public class Class339 {
	...
	public Class352 method4116(int i, int i_0_) {
		try {
			...
			synchronized (((Class339) this).aClass243_3634) {
				is = (((Class339) this).aClass243_3634.getFileFromArchive(-1006924897 * Class120.aClass120_1441.anInt1460, i, (byte) -50));
			}
	...
	public Class339(Class411 class411, Class429 class429, Js5 class243, Js5 class243_4_) {
	...
	static final void method4123(ClientScript2 class403, byte i) {
		try {
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = Class165.aClass319_6366.method3883((byte) -67);
		} catch (RuntimeException runtimeexception) {
	...
	static final void method4124(ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = 1882038855 * Class376.anInt4090 + WorldMap.mapY;
		} catch (RuntimeException runtimeexception) {
