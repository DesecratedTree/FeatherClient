...
public class WorldMap {
	...
	static LinkedList aClass437_3226 = new LinkedList(16);
		...
		for (int i_37_ = 0; i_37_ < 3; i_37_++) {
			for (int i_38_ = i_33_; i_38_ <= i_35_; i_38_++) {
				for (int i_39_ = i_34_; i_39_ <= i_36_; i_39_++) {
					...
					if (arraylist != null) {
						int i_40_ = (i_38_ + (mapX >> 6)) * 64;
						int i_41_ = (i_39_ + (mapY >> 6)) * 64;
						Iterator iterator = arraylist.iterator();
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_42_ = (i_40_ + ((Class312) class312).aByte3292 - mapX - anInt3230);
							int i_43_ = (i_41_ + ((Class312) class312).aByte3293 - mapY - anInt3242);
			...
			for (int i_48_ = i_33_; i_48_ <= i_35_; i_48_++) {
				for (int i_49_ = i_34_; i_49_ <= i_36_; i_49_++) {
					...
					if (arraylist != null) {
						int i_50_ = (i_48_ + (mapX >> 6)) * 64;
						int i_51_ = (i_49_ + (mapY >> 6)) * 64;
						Iterator iterator = arraylist.iterator();
						while (iterator.hasNext()) {
							Class312 class312 = (Class312) iterator.next();
							int i_52_ = (i_50_ + ((Class312) class312).aByte3292 - mapX - anInt3230);
							int i_53_ = (i_51_ + ((Class312) class312).aByte3293 - mapY - anInt3242);
	...
	public static void method3690(Js5 worldmapIndex, Class375 class375, Class451 class451, Class433 class433, Class339 class339, Class487 class487, Interface23 interface23) {
		...
		if (files != null) {
			for (int i = 0; i < files.length; i++) {
				Class298_Sub37_Sub13 class298_sub37_sub13 = Class469.method6048(worldMapIndex, archive, files[i], 1783056581);
	...
	static void method3692(int i) {
		aClass298_Sub37_Sub13_3218 = (Class298_Sub37_Sub13) aClass437_3226.method5812((long) i);
	}
		...
		if ((i_74_ & 0x1) == 0) {
			...
			for (int i_78_ = 0; i_78_ < i_76_; i_78_++) {
				...
				if (i_78_ == 0) {
					...
					if ((anArrayListArrayArrayArray3249[i_78_ - 1][i - (mapX >> 6)][i_70_ - (mapY >> 6)]) == null)
						anArrayListArrayArrayArray3249[i_78_ - 1][i - (mapX >> 6)][i_70_ - (mapY >> 6)] = new ArrayList();
					Class312 class312 = new Class312(i_71_ & 0x3f, i_72_ & 0x3f, i_79_, i_80_, i_81_, is_86_, is_87_);
					anArrayListArrayArrayArray3249[i_78_ - 1][i - (mapX >> 6)][i_70_ - (mapY >> 6)].add(class312);
				}
			}
		}
	}
	...
	static void method3697() {
		...
		for (int i = 0; i < aClass296_3235.anInt3169 * -1407078377; i++) {
			...
			if (bool) {
				...
				class298_sub52.anInt7607 = (is[1] - mapX) * 898378357;
				class298_sub52.anInt7610 = (is[2] - mapY) * -1686044477;
	...
	static void method3699(GraphicsToolkit class_ra, int i, int i_120_) {
		System.out.println("Loadin: " + aClass298_Sub37_Sub13_3218.aString9640);
		RsByteBuffer buffer = new RsByteBuffer(worldMapIndex.method2301(aClass298_Sub37_Sub13_3218.aString9640, "area", -1304297711));
		...
		while (buffer.index * 385051775 < buffer.buffer.length) {
			if (buffer.readUnsignedByte() == 0) {
				...
				for (int x = 0; x < 64; x++) {
					for (int y = 0; y < 64; y++) {
						int localX = regionX * 64 + x - mapX;
						int localY = regionY * 64 + y - mapY;
						method3695(class_ra, buffer, regionX, regionY, localX, localY, data, data2);
					}
				}
			} else {
				int regionX = buffer.readUnsignedByte();
				int regionY = buffer.readUnsignedByte();
				int i_134_ = buffer.readUnsignedByte();
				int i_135_ = buffer.readUnsignedByte();
				for (int x = 0; x < 8; x++) {
					for (int y = 0; y < 8; y++) {
						int localX = regionX * 64 + i_134_ * 8 + x - mapX;
						int localY = regionY * 64 + i_135_ * 8 + y - mapY;
						method3695(class_ra, buffer, regionX, regionY, localX, localY, data, data2);
					}
				}
			}
	...
	public static Class298_Sub37_Sub13 method3705(int i) {
		return (Class298_Sub37_Sub13) aClass437_3226.method5812((long) i);
	}
	...
	static void method3709(int i, int i_188_, int i_189_, int i_190_, int i_191_, int i_192_, int i_193_, int i_194_) {
		anInt3230 = i - mapX;
		anInt3241 = i_188_ - mapY;
		anInt3252 = i_189_ - mapX;
		anInt3242 = i_190_ - mapY;
		anInt3221 = i_191_;
		anInt3255 = i_192_;
		anInt3256 = i_193_;
		anInt3257 = i_194_;
							...
							if (((Class312) class312).anIntArray3288 != null) {
								for (int i_201_ = 0; i_201_ < (((Class312) class312).anIntArray3288).length; i_201_++) {
									...
									if (i_202_ != -1) {
										...
										class298_sub52.anInt7607 = ((i_199_ + (mapX >> 6)) * 64 + (((Class312) class312).aByte3292) - mapX) * 898378357;
										class298_sub52.anInt7610 = ((i_200_ + (mapY >> 6)) * 64 + (((Class312) class312).aByte3293) - mapY) * -1686044477;
