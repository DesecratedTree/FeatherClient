	...
	public static void method5851(int i, int i_7_) {
		try {
			if (i != client.anInt8752 * -1233866115) {
				...
				if (19 == i)
					Class501.method6227((8 == -1233866115 * client.anInt8752 || -1233866115 * client.anInt8752 == 2 || (747461259 * (LinkedList.aClass371_5520.anInt4042) != (client.WINDOW_PANE_ID * -257444687))), -1608675861);
				if (i == 14)
					IcmpService_Sub1.method6382((client.WINDOW_PANE_ID * -257444687 != (LinkedList.aClass371_5520.anInt4031) * 1349088077), -687019075);
				if (i == 4 || 6 == i)
