...
public class Class352 {
		...
		try {
			if (1 == i)
				...
				if (((Class352) this).aClass437_3811 == null) {
					...
					((Class352) this).aClass437_3811 = new LinkedList(i_9_);
				}
	...
	public String method4239(int i, String string, byte i_17_) {
		try {
			if (null == ((Class352) this).aClass437_3811)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((Class352) this).aClass437_3811.method5812((long) i));
	...
	public int method4241(int i, int i_18_, int i_19_) {
		try {
			if (((Class352) this).aClass437_3811 == null)
				return i_18_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((Class352) this).aClass437_3811.method5812((long) i));
