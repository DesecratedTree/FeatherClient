...
public class Class451 {
	...
	public Class443 method5932(int i, byte i_1_) {
		try {
			Class443 class443;
			synchronized (((Class451) this).aClass348_5640) {
				class443 = (Class443) ((Class451) this).aClass348_5640.get((long) i);
			}
			if (class443 != null)
				return class443;
			byte[] is;
			synchronized (((Class451) this).aClass243_5639) {
				is = (((Class451) this).aClass243_5639.getFileFromArchive(-1006924897 * Class120.aClass120_1428.anInt1460, i, (byte) -122));
			}
