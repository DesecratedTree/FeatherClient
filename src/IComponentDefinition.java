...
public class IComponentDefinition {
	...
	public String method1109(int i, String string, int i_0_) {
		try {
			if (null == ((IComponentDefinition) this).aClass437_1279)
				return string;
			Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((IComponentDefinition) this).aClass437_1279.method5812((long) i));
	...
	void method1110(RsByteBuffer class298_sub53, int i) {
		try {
			...
			if (65535 == anInt1160 * 1573706803)
				...
				anInt1160 = (anInt1160 * 1573706803 + (-440872681 * anInt1142 & ~0xffff)) * -1171161349;
			...
			if (6 == -1215239439 * anInt1144) {
				...
				if (bool) {
					...
					anInt1284 = class298_sub53.readUnsignedShort() * -1066050969;
					...
					anInt1262 = class298_sub53.readUnsignedShort() * 1590511671;
					anInt1192 = class298_sub53.readUnsignedShort() * -2064327287;
					anInt1284 = class298_sub53.readShort(1622637773) * -1066050969;
				}
			...
			if (anInt1144 * -1215239439 == 4) {
				...
				if (aString1212.toLowerCase().contains("runescape")) {
					aString1212 = aString1212.replace("runescape", ClientSettings.SERVER_NAME);
					aString1212 = aString1212.replace("RuneScape", ClientSettings.SERVER_NAME);
					aString1212 = aString1212.replace("Runescape", ClientSettings.SERVER_NAME);
				}
			...
			if (i_11_ > 0) {
				...
				for (int i_13_ = 0; i_13_ < i_11_; i_13_++)
					aStringArray1195[i_13_] = class298_sub53.readString(-1637502084);
			}
			if (i_12_ > 0) {
			...
			if (i_1_ >= 0) {
				...
				for (int i_19_ = 0; i_19_ < i_18_; i_19_++) {
					...
					((IComponentDefinition) this).aClass437_1279.method5817(new Class298_Sub35(i_21_), (long) i_20_);
				}
				...
				for (int i_23_ = 0; i_23_ < i_22_; i_23_++) {
					...
					((IComponentDefinition) this).aClass437_1279.method5817(new Class298_Sub29(string), (long) i_24_);
				}
			}
	...
	public void method1114(GraphicsToolkit class_ra, Class387 class387, Class222 class222, int i, int i_28_) {
		try {
			...
			if (aClass351_1218 != null)
				aClass351_1218.method4231(class_ra, (long) i, class85s, class68s, false);
		} catch (RuntimeException runtimeexception) {
	...
	public int method1117(int i, int i_39_, int i_40_) {
		try {
			if (null == ((IComponentDefinition) this).aClass437_1279)
				return i_39_;
			Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((IComponentDefinition) this).aClass437_1279.method5812((long) i));
	...
	public void method1119(int i, String string, byte i_43_) {
		try {
			if (null == ((IComponentDefinition) this).aClass437_1279) {
				((IComponentDefinition) this).aClass437_1279 = new LinkedList(16);
				((IComponentDefinition) this).aClass437_1279.method5817(new Class298_Sub29(string), (long) i);
			} else {
				Class298_Sub29 class298_sub29 = ((Class298_Sub29) ((IComponentDefinition) this).aClass437_1279.method5812((long) i));
	...
	public void method1123(int i, int i_47_) {
		try {
			if (((IComponentDefinition) this).aClass437_1279 != null) {
				Class298 class298 = ((IComponentDefinition) this).aClass437_1279.method5812((long) i);
				if (class298 != null)
			...
			if (1 == anInt1184 * 1548853569) {
				...
				if (((IComponentDefinition) this).aShortArray1118 != null) {
					for (int i_50_ = 0; i_50_ < ((IComponentDefinition) this).aShortArray1118.length; i_50_++) {
						l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1118[i_50_]) >> 8)) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1118[i_50_])) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1203[i_50_]) >> 8)) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1203[i_50_])) & 0xffL)];
					}
					i |= 0x4000;
				}
				if (null != ((IComponentDefinition) this).aShortArray1204) {
					for (int i_51_ = 0; i_51_ < ((IComponentDefinition) this).aShortArray1204.length; i_51_++) {
						l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1204[i_51_]) >> 8)) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1204[i_51_])) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) ((((IComponentDefinition) this).aShortArray1234[i_51_]) >> 8)) & 0xffL)];
						l = l >>> 8 ^ ls[(int) ((l ^ (long) (((IComponentDefinition) this).aShortArray1234[i_51_])) & 0xffL)];
					}
					i |= 0x8000;
				}
				long l_52_ = ((long) (class_ra.anInt5298 * 580915349) << 59 | (long) (anInt1184 * 1548853569) << 54 | (long) (anInt1151 * 572201537) << 38 | l & 0x3fffffffffL);
				Class387 class387 = (Class387) aClass348_1138.get(l_52_);
				if (null == class387 || class_ra.method5017(class387.m(), i) != 0) {
					...
					if (null != ((IComponentDefinition) this).aShortArray1118) {
						for (int i_53_ = 0; i_53_ < ((IComponentDefinition) this).aShortArray1118.length; i_53_++)
							class387.X((((IComponentDefinition) this).aShortArray1118[i_53_]), (((IComponentDefinition) this).aShortArray1203[i_53_]));
					}
					if (((IComponentDefinition) this).aShortArray1204 != null) {
						for (int i_54_ = 0; i_54_ < ((IComponentDefinition) this).aShortArray1204.length; i_54_++)
							class387.W((((IComponentDefinition) this).aShortArray1204[i_54_]), (((IComponentDefinition) this).aShortArray1234[i_54_]));
					}
	...
	public void method1125(int i, int i_58_, int i_59_) {
		try {
			if (null == ((IComponentDefinition) this).aClass437_1279) {
				((IComponentDefinition) this).aClass437_1279 = new LinkedList(16);
				((IComponentDefinition) this).aClass437_1279.method5817(new Class298_Sub35(i_58_), (long) i);
			} else {
				Class298_Sub35 class298_sub35 = ((Class298_Sub35) ((IComponentDefinition) this).aClass437_1279.method5812((long) i));
				if (class298_sub35 == null)
					((IComponentDefinition) this).aClass437_1279.method5817(new Class298_Sub35(i_58_), (long) i);
	...
	public Class57 method1128(GraphicsToolkit class_ra, int i) {
		try {
			aBoolean1139 = false;
			long l = (((aBoolean1180 ? 1L : 0L) << 38) + (((aBoolean1182 ? 1L : 0L) << 35) + (long) (anInt1175 * 1411971043) + ((long) (anInt1178 * 547522005) << 36)) + ((aBoolean1181 ? 1L : 0L) << 39) + ((long) (anInt1251 * -2065110161) << 40));
	...
	static void method1130(ClientScript2 class403, int i) {
		try {
			((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919 - 1] = (Class316.aClass362_3318.method4307((((ClientScript2) class403).anIntArray5244[((ClientScript2) class403).anInt5239 * 681479919 - 1]), 245040087).method4563(Class128.aClass148_6331, client.anIntArray8828, (byte) 76)) ? 1 : 0;
		} catch (RuntimeException runtimeexception) {
	...
	static final void method1134(ClientScript2 class403, int i) {
		try {
			int i_68_ = (((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 -= -391880689) * 681479919)]);
			Class298_Sub37_Sub13 class298_sub37_sub13 = Class298_Sub7.method2864(142245824);
	...
	static final void method1135(Class365_Sub1 class365_sub1, ClientScript2 class403, int i) {
		try {
			...
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_69_;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_70_;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_71_;
			((ClientScript2) class403).anIntArray5244[((((ClientScript2) class403).anInt5239 += -391880689) * 681479919 - 1)] = i_72_;
		} catch (RuntimeException runtimeexception) {
